...
local function MBLLMTK_fake_script() -- Side.TabHandler 
	...
	local scriptgui = script.Parent.Scripts
...
coroutine.wrap(MBLLMTK_fake_script)()
local function XGQGFL_fake_script() -- Main.LocalScript 
...
coroutine.wrap(XGQGFL_fake_script)()
local function QWETGRN_fake_script() -- IY.Scripthandler 
...
coroutine.wrap(QWETGRN_fake_script)()
local function UTVFHXG_fake_script() -- ax.Scripthandler 
...
coroutine.wrap(UTVFHXG_fake_script)()
local function UECMPXV_fake_script() -- TextButton_2.Scripthandler 
...
coroutine.wrap(UECMPXV_fake_script)()
end
